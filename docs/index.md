...
<div className="container">
  <div className="row">
    ...
    <div className="col col--4 margin-bottom--lg">
      <a className="card padding--lg cardContainer_node_modules-@docusaurus-theme-classic-lib-theme-DocCard-styles-module" href={useBaseUrl('/docs/audios/overview')} style={{ height: '100%', textAlign: 'center', display: 'block' }}>
    ...
    <div className="col col--4 margin-bottom--lg">
      <a className="card padding--lg cardContainer_node_modules-@docusaurus-theme-classic-lib-theme-DocCard-styles-module" href={useBaseUrl('/docs/orbiters/overview')} style={{ height: '100%', textAlign: 'center', display: 'block' }}>
