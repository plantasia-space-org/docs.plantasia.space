...
Sube una imagen de portada para el Audio.

Si no tienes una, puedes generarla desde fuentes de dominio público y personalizarla con el editor integrado.
...
Puedes asignar más de un artista, pero deben existir previamente en la plataforma como un xPlorer.

Otrxs colaboradorxs que no estén en la plataforma pueden acreditarse más adelante.
...
Agrega metadatos, descripción e información contextual.
...
- **Con enlace**: accesible mediante link directo, no aparece públicamente
- **Público**: se puede buscar y ver en toda la plataforma
